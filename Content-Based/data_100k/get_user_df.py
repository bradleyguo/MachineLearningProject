...
ratings_train = pd.merge(user_ratings_train, movie_genres, on='movie_id', how='inner', sort=False)
#ratings_train.groupby("user_id")

ratings_test = pd.merge(user_ratings_test, movie_genres, on='movie_id', how='inner',sort=False)
#print(users_df.head())
